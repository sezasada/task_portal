...
export default function UserDashboard() {
    ...
    const allCompletedTasks = useSelector((store) => store.allCompletedTasksReducer);
    const userCompletedTasks = useSelector((store) => store.allCompletedUserTaskReducer);
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography varient="h6" component="h4">
                                Date Completed: {moment(infoOfSpecificTask.time_completed).format("MMMM Do YYYY, h:mm a")}
                            </Typography>
                            <Typography variant="h6" component="h4">
                                Location: {infoOfSpecificTask.location_name}
                            </Typography>
